            			...
            			if ( result.flag) {
            				...
            				$.each(certList, function(i, cert){
             				   content = content +  '<tr>';
          					   ...
          					   content = content +  '      <button type="button" onclick="window.location.href=\'${pageContext.request.contextPath}/cert/edit.htm?pageNum='+pageInfo.pageNum+'&id='+cert.id+'\'" class="btn btn-primary btn-xs"><i class=" glyphicon glyphicon-pencil"></i></button>';
            				...
            				var pageContent = "";
                            pageContent = pageContent + '<li><a href="#" onclick="changepageNum('+(pageInfo.pageNum-1)+')">上一页</a></li>';

            				for ( var i = 1; i <= pageInfo.pages; i++ ) {
            					if ( i == pageInfo.pageNum ) {
            						pageContent = pageContent + '<li class="active"><a href="#" onclick="changepageNum('+i+')">'+i+'</a></li>';	
            					} else {
            						pageContent = pageContent + '<li><a href="#" onclick="changepageNum('+i+')">'+i+'</a></li>';
            					}
            					
            				}

                            pageContent = pageContent + '<li><a href="#" onclick="changepageNum('+(pageInfo.pageNum+1)+')">下一页</a></li>';
