 ...
 <div class="navbar-wrapper">
			...
			<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
			  <div class="container">
				<div class="navbar-header">
				  <a class="navbar-brand" href="index.do" style="font-size:32px;">尚筹网-创意产品众筹平台</a>
				</div>
            <div id="navbar" class="navbar-collapse collapse" style="float:right;">
              <ul class="nav navbar-nav navbar-right">
                <li><a href="${pageContext.request.contextPath}/login.do">登录</a></li>
                <li><a href="${pageContext.request.contextPath}/reg.do">注册</a></li>
              </ul>
            </div>
			  </div>
			</nav>
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active" onclick="window.location.href='project.dol'" style="cursor:pointer;">
          <img src="img/carousel-1.jpg" alt="First slide">
        </div>
        <div class="item" onclick="window.location.href='project.dol'" style="cursor:pointer;">
    ...
    <div class="container marketing">
      ...
      <div class="row">
        <div class="col-lg-4">
          ...
          <p><a class="btn btn-default" href="project.dol" role="button">项目详情 &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
			...
			<div class="row">
				<div class="col-md-3">
					<div class="thumbnail">
						...
						<div class="caption">
							<h3 class="break">
								<a href="project.dol">活性富氢净水直饮机</a>
							</h3>
                            <p>
				...
				<div class="col-md-3">
					<div class="thumbnail">
						...
						<div class="caption">
							<h3 class="break">
								<a href="project.dol">酷驰触控龙头，智享厨房黑科技</a>
							</h3>
                            <p>
                                <div style="float:left;"><i class="glyphicon glyphicon-screenshot" title="目标金额" ></i> $20,000 </div>
                                <div style="float:right;"><i title="截至日期" class="glyphicon glyphicon-calendar"></i> 2017-20-20 </div>
				...
				<div class="col-md-3">
					<div class="thumbnail">
						...
						<div class="caption">
							<h3 class="break">
								<a href="project.dol">小熊猫鱼眼全景安防摄像机</a>
							</h3>
                            <p>
                                <div style="float:left;"><i class="glyphicon glyphicon-screenshot" title="目标金额" ></i> $20,000 </div>
                                <div style="float:right;"><i title="截至日期" class="glyphicon glyphicon-calendar"></i> 2017-20-20 </div>
...
<div class="container">
    ...
    $(".thumbnail img").click(function(){
        window.location.href = "project.dol";
    });
    </script>
  </body>
</html>