   			    ...
   			    view : {
					...
					addHoverDom: function(treeId, treeNode){   //设置自定义按钮组,在节点后面悬停显示增删改按钮组.
						...
						if ( treeNode.level == 0 ) { //根节点
							s += '<a class="btn btn-info dropdown-toggle btn-xs" style="margin-left:10px;padding-top:0px;" href="#" onclick="window.location.href=\'${pageContext.request.contextPath}/permission/toAdd.do?id='+treeNode.id+'\'" >&nbsp;&nbsp;<i class="fa fa-fw fa-plus rbg "></i></a>';
						} else if ( treeNode.level == 1 ) { //分支节点
							s += '<a class="btn btn-info dropdown-toggle btn-xs" style="margin-left:10px;padding-top:0px;"  href="#" onclick="window.location.href=\'${pageContext.request.contextPath}/permission/toUpdate.do?id='+treeNode.id+'\'" title="修改权限信息">&nbsp;&nbsp;<i class="fa fa-fw fa-edit rbg "></i></a>';
    			    ...
    			    $.ajax({
            	    	...
            	    	success:function(result){
            	    		if(result.flag){
                                ...
                                //treeObj.reAsyncChildNodes(null,"refresh");刷新树
            	    		}else{
            	    			alert("删除许可数据失败...");
            	    		}
            	    	}
