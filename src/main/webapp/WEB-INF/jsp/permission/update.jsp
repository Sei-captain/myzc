    ...
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <ol class="breadcrumb">
                ...
                <li><a href="${pageContext.request.contextPath}/permission/index.do">数据列表</a></li>
                ...
                <div class="panel-body">
                    <form id="addForm">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" id="furl" value="${permission.url }"
                                   placeholder="请输入许可URL">
                        </div>
                        <div class="form-group">
                            <label for="ficon">图标</label>
                            <select id="ficon">
...
<script type="text/javascript">
    $(function () {
        ...
        $.ajax({
            type: "post",
            url: "${pageContext.request.contextPath}/permission/icon.do",
            success: function (result) {
                if (result.flag) {
                    var data = result.data;
                    var content = '';
                    $.each(data, function (i, n) {
                        if (n.icon == "${permission.icon}") {
                            content += '<option selected>' + n.icon + '</option>';
                        } else {
                            content += '<option >' + n.icon + '</option>';
                        }
                    });
                    $("select").html(content);
                } else {
    ...
    $("#updateBtn").click(function () {
        ...
        $.ajax({
            ...
            success: function (result) {
                if (result.flag) {
                    window.location.href = "${pageContext.request.contextPath}/permission/index.do";
                } else {
