            ...
            <div class="panel panel-default">
                <div>
                    <ol class="breadcrumb">
                        ...
                        <li><a href="${pageContext.request.contextPath}/role/index.do">角色维护</a></li>
...
<script type="text/javascript">
    $(function () {
        ...
        var setting = {
            ...
            async: {
                enable: true, //采用异步
                url: "${pageContext.request.contextPath}/role/loadDataAsync.do?roleid=${param.id}", // ?id=1&n=xxx&lv=2
