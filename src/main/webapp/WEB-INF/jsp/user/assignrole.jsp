    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="container-fluid">
        <div class="navbar-header">
            <div><a class="navbar-brand" style="font-size:32px;" href="${pageContext.request.contextPath}/user/index.do">众筹平台 - 用户维护</a></div>
        </div>
				...
				<form role="form" class="form-inline">
				  <div class="form-group">
					...
					<select id="leftRoleList" class="form-control" multiple size="10" style="width:250px;overflow-y:auto;">
                        <c:forEach items="${roleNo}" var="role">
				  ...
				  <div class="form-group" style="margin-left:40px;">
					...
					<select id="rightRoleList" class="form-control" multiple size="10" style="width:250px;overflow-y:auto;">
                        <c:forEach items="${roleHave}" var="role">
	                        <option value="${role.id }">${role.name }</option>
                        </c:forEach>  
                    </select>
				  </div>
